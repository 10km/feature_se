...
cmake -G "Unix Makefiles" \
  ...
  -DBUILD_gflags_LIB=ON \
	-DCMAKE_INSTALL_PREFIX=$sh_folder/gflags-linux-x86 \
	..
make install -j8
popd
rm -fr build_gcc_x86
...
cmake -G "Unix Makefiles" \
  ...
  -DBUILD_STATIC_LIBS=ON \
  -DBUILD_gflags_LIB=ON \
	-DCMAKE_INSTALL_PREFIX=$sh_folder/gflags-linux-x86_64 \
	..
make install -j8
popd
